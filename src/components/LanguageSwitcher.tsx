  ...
  return (
    <label className={`relative inline-flex items-center ${className}`}>
      ...
      <select
        ...
        className="appearance-none cursor-pointer rounded-md border border-[var(--border)] bg-transparent
                   py-1.5 pl-2.5 pr-7 text-sm font-medium text-[var(--foreground)]
                   hover:bg-[var(--surface-2)] focus:outline-none focus:border-[var(--primary)]"
      >
        {LOCALES.map((l) => (
